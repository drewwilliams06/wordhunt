import { IAwake,Vector2D,Color,Font } from '@/utils'
...
export class Canvas {
    ...
    public FillLetter(center: Vector2D, color: Color, text: string, font: Font): void { 
        this._ctx.font = font.AsString()
        this._ctx.textAlign = "center"
        this._ctx.fillText(text,center.x,center.y)
    }
